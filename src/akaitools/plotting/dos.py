"""Density-of-states plotting for AkaiKKR DOS results."""
...
if TYPE_CHECKING:
    ...
    from akaitools.models import DOSResult

from akaitools.errors import InvalidParameterError
from akaitools.plotting.common import plt
from akaitools.plotting.styles import COLORS, EF_COLOR, STYLE_RC, ZERO_LINE_COLOR
